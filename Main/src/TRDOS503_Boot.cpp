...
#include "TRDOS.h"
	...
	TStdWinError CTRDOS503::__recognizeDisk__(PImage image,TFormat &outFormatBoot){
		...
		constexpr Medium::TFormatDef Def=DefFdMfmFormat256( DD, 1,2,TRDOS503_TRACK_SECTORS_COUNT );
	...
	const CFormatDialog::TStdFormat CTRDOS503::StdFormats[]={ // zeroth position must always be occupied by the biggest capacity
		{ DS80_CAPTION, 0, DefFdMfmFormat256(DD,    79,2,TRDOS503_TRACK_SECTORS_COUNT), 2, 0, TRDOS_SECTOR_GAP3, 0, 128 },
		{ DS40_CAPTION, 0, DefFdMfmFormat256(DD_525,39,2,TRDOS503_TRACK_SECTORS_COUNT), 2, 0, TRDOS_SECTOR_GAP3, 0, 128 },
		{ SS80_CAPTION, 0, DefFdMfmFormat256(DD,	 79,1,TRDOS503_TRACK_SECTORS_COUNT), 2, 0, TRDOS_SECTOR_GAP3, 0, 128 },
		{ DS40_CAPTION, 0, DefFdMfmFormat256(DD,    39,2,TRDOS503_TRACK_SECTORS_COUNT), 2, 0, TRDOS_SECTOR_GAP3, 0, 128 },
		{ SS40_CAPTION, 0, DefFdMfmFormat256(DD,	 39,1,TRDOS503_TRACK_SECTORS_COUNT), 2, 0, TRDOS_SECTOR_GAP3, 0, 128 },
		{ SS40_CAPTION, 0, DefFdMfmFormat256(DD_525,39,1,TRDOS503_TRACK_SECTORS_COUNT), 2, 0, TRDOS_SECTOR_GAP3, 0, 128 }
	};
