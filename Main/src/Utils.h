...
namespace Utils{
	...
	public:
		...
		bool GetDlgItemIntList(WORD id,Memory::CIntList &rOutList,const PropGrid::Integer::TUpDownLimits &limits,int nIntsMin=0,int nIntsMax=INT_MAX) const;
		void SetDlgItemIntList(WORD id,const Memory::CIntList &list) const;
