#include "stdafx.h"
	...
	void CSpectrumDos::CTape::GetTrackData(TCylinder cyl,THead,Revolution::TType,PCSectorId,PCBYTE,TSector,bool,PSectorData *outBufferData,PWORD outBufferLengths,TFdcStatus *outFdcStatuses){
