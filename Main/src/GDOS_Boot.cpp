...
#include "GDOS.h"
	...
	static const CFormatDialog::TStdFormat StdFormats[]={
		{ _T("DS 80x10"), 0, {TMedium::FLOPPY_DD_ANY,GDOS_CYLINDERS_COUNT-1,2,GDOS_TRACK_SECTORS_COUNT,GDOS_SECTOR_LENGTH_STD_CODE,GDOS_SECTOR_LENGTH_STD,1}, 1, 0, FDD_350_SECTOR_GAP3, 1, GDOS_DIR_FILES_COUNT_MAX }
	};
