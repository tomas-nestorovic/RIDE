...
#define DOS_H
	...
	protected:
		...
		CDos(PImage _image,RCFormat formatBoot,TTrackScheme trackAccessScheme,PCProperties _properties,TFnCompareNames _fnCompareNames,UINT nResId,CFileManagerView * _pFileManager,TGetFileSizeOptions _getFileSizeDefaultOption,TSectorStatus unformatFatStatus);
	...
	public:
		...
		bool IsSectorStatusBadOrEmpty(RCPhysicalAddress chs) const;
