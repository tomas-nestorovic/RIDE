...
The policy of DOS implementations in RIDE ([see FAQ](https://nestorovic.eu/ride/html/faq_supportedSystems.html)) is to not hide anything from the user: boot sector(s), FAT items, directory entries, hidden files, file attributes and other information is all at your disposal.
...
- It automatically recognizes the [disk operating system](https://nestorovic.eu/ride/html/faq_supportedSystems.html) (DOS) and corresponding disk format without user's intervention (though the user may step in). Just insert the disk, access it via RIDE and immediatelly work with the files.
- It supports [various real devices](https://nestorovic.eu/ride/html/faq_realFdd.html) connected locally, such as KryoFlux or Greaseweazle.
...
- It [can run in Linux](https://nestorovic.eu/ride/html/faq_linux.html).
...
Here is just a list of the _really_ frequent ones. The full list can be accessed through _Help → FAQ_ or [here on-line](http://nestorovic.eu/ride/html/faq.html).
- [What filesystems are supported?](http://nestorovic.eu/ride/html/faq_supportedSystems.html)
- [How do I access a real floppy?](http://nestorovic.eu/ride/html/faq_accessFloppy.html)
- [How do I create an image of a real floppy?](http://nestorovic.eu/ride/html/faq_floppy2image.html)
- [How do I dump an image back to a floppy?](http://nestorovic.eu/ride/html/faq_image2floppy.html)
- [How do I format a realy floppy?](http://nestorovic.eu/ride/html/faq_formatFloppy.html)
- [How do I convert one image to another?](http://nestorovic.eu/ride/html/faq_convertImage.html)
# Contributing
